...
var { CachedInputFileSystem, ResolverFactory } = require("enhanced-resolve");
var fs = require("fs");
// create a resolver
const tsxResolver = ResolverFactory.createResolver({
      ...
      forEachBail(
        ...
        function (fileName, innerCallback) {
          ...
          resolver
            ...
            .doResolve(target, obj, "using path: " + filePath, resolveContext, innerCallback);
        },
